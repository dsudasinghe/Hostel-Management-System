...
('wenasara', 'lalindu', '1234', 'lalindu', '81dc9bdb52d04dc20036dbd8313ed055', 'hi@gmail.com'),
('lalindu', 'wenasara', '21005555', 'lalindu', '1234', 'lalindu@gmail.com'),
('admin', 'admin', '5555566', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@gmail.com');
...
(222, 'test2', 444, 'SOC', 188000, 1),
(445, 'maleesh', 55577755, 'SOC', 5555555, 0),
(12345, 'test', 123, 'SOC', 655500, 0),
(54321, 'beckey', 77111111, 'SOC', 150000, 0),
(21005548, 'SPLD Sudasinghe', 712055296, 'SOC', 15099, 0),
(21005555, 'SPLW Sudasinghe', 746982736, 'SOC', 5774000, 1);
...
--
ALTER TABLE `paymenthistory`
  MODIFY `paymentid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

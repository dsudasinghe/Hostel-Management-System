...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2020 at 07:04 AM
...
INSERT INTO `student` (`id`, `name`, `tel`, `faculty`, `moneyPaid`, `room_id`) VALUES
(222, 'test2', 444, 'SOC', 12000, 0),
(12345, 'test', 123, 'SOC', 66, 0),
(21005548, 'SPLD Sudasinghe', 712055296, 'SOC', 99, 0),
(21005555, 'SPLW Sudasinghe', 746982736, 'SOC', 60003, 0);
